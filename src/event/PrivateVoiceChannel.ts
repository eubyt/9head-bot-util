...
export class PrivateVoiceChannel implements EventHandler<'VoiceState'> {
    async execute(oldState: VoiceState, newState: VoiceState) {
        ...
        if (
            newState.channelId === '1400700280823222373' ||
            oldState.channelId === '1400700280823222373'
        )
            return;
        ...
        console.log('PrivateVoiceChannel', {
            ...
            verdadeiro: newState.channelId !== channelId,
        });
            ...
            if (newState.channel && newState.channelId === channelId) {
                ...
                await newChannel.send({
                    content:
                        ...
                        '</canalprivado-persistencia:1317474322381799554> para tornar o canal persistente (Nunca ser deletado).\n' +
                        '</canalprivado-ocultar:1370098610200645803> para ocultar o canal.\n' +
                        '\n' +
                        '<@' +
                        userId +
                        '> ',
